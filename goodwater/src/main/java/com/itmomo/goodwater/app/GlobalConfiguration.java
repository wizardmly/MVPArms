package com.itmomo.goodwater.app;
...
import com.itmomo.goodwater.BuildConfig;
import com.itmomo.goodwater.mvp.model.api.Api;
 ...
 * @see com.jess.arms.integration.ManifestParser Created by MVPArmsTemplate <a
...
//                })
        ...
        .retrofitConfiguration(
            (context1, retrofitBuilder) -> {//这里可以自己自定义配置 Retrofit 的参数, 甚至您可以替换框架配置好的 OkHttpClient 对象 (但是不建议这样做, 这样做您将损失框架提供的很多功能)
